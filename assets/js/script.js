(function($) {
    ...
    var switcherHtml = '<div class="style-switcher-box"> <div class="switcher-inner"><h5>CONTACT DETAILS</h5> <div class="main-list"> <div class="list"> <span class="list-title"><i class="fa fa-home"></i>Trillion <br> Middle East Technologies <br>P.O. Box: 1234 <br>Dubai , UAE</span> <i class="fa fa-phone"></i> +971 (50) 123456<ul class="color-chager"><i class="fa fa-envelope"></i> info@trillionmet.com </ul>  </div>  </div>  </div> <button class="toggle-btn"><i class="fa fa-mobile"></i></button> </div>';
